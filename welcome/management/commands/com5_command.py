...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		...
		session = "e214d057e622a1b778aa"
		server = "com5"
		data = '{"controller":"ranking","action":"getRankAndCount","params":{"id":4038,"rankingType":"ranking_Player","rankingSubtype":"population"},"session":"'+session+'"}'
		...
		for player_id in data_map :
			...
			player= None
			try :
				player = Player.objects.using(server).get(id=player_id)
