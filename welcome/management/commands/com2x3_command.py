...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		...
		session = "68ee449baa617197530e"
		server = "com2x3"
		data = '{"controller":"ranking","action":"getRankAndCount","params":{"id":972,"rankingType":"ranking_Player","rankingSubtype":"population"},"session":"'+session+'"}'
		...
		for player_id in data_map :
			...
			player= None
			try :
				player = Player.objects.using('com2x3').get(id=player_id)
		...
		Log.objects.using('com2x3').bulk_create(log_list)
